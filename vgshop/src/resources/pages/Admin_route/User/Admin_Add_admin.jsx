...
const Admin_Add_admin = () => {
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            setError("Admin has been created!")
        }
        catch(err) {
    ...
    return (
        <div className="">
            <h2>Add admin</h2>
            <p className={`admin-form-default ${err === "Admin has been created!"? "admin-form-success":"admin-form-caution"}`}>{err}</p>
            <form className="form d-flex flex-column admin-form">
                ...
                <div className="admin-form-submit-group">
                    <button className="admin-form-submit" onClick={handleSubmit}>Add admin</button>
                </div>
            </form>
        </div>
    )
