...
const Admin_Update_admin = () => {
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            setError("Admin has been updated!")
            setTimeout(() => setError(null), 1500);
            setUpdateItem(null);
    ...
    return (
        <div className="">
            <h2>Update user</h2>
            <p className={`admin-form-default ${err === "Admin has been updated!"? "admin-form-success":"admin-form-caution"}`}>{err}</p>
            {updateItem === null ?
...
export default Admin_Update_admin 