            ...
            {!game ?
                ...
                <div className="game-content">
                    ...
                    <div className="game-text">
                        ...
                        <button className={`game-button ${cart.includes(game.game_id) ? "game-button-remove" : "game-button-add"}`} onClick={() => handleCart(game.game_id)}>{cart.includes(game.game_id) ? "Remove":"Add to Cart"}</button>
